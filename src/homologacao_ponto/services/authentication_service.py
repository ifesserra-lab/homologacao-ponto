...
from homologacao_ponto.infrastructure.sigrh_browser import SigrhBrowser, SigrhLoginResult
from homologacao_ponto.models import Credential


class AuthenticationService:
    def __init__(self, browser: SigrhBrowser, logger: logging.Logger | None = None) -> None:
